...
if __name__ == '__main__':
    ...
    parser.add_argument("-bert_data_path", default='../bert_data/xsum_test') # for validation
    ...
    parser.add_argument("-result_path", default='../results/xsum/xsum_abs_test')
    ...
    parser.add_argument("-text_src", default='../bert_data/xsum_test/test.document')
    parser.add_argument("-text_tgt", default='../bert_data/xsum_test/test.summary')
    ...
    parser.add_argument('-log_file', default='../logs/xsum_abs_test.log')
    ...
    parser.add_argument("-neptune_exp_tags", default=['ExpTest'])
...
# python train.py  -task abs -mode train -bert_data_path ../bert_data/bert_data_xsum/xsum -dec_dropout 0.2  -model_path ../models/xsum \
# -sep_optim true -lr_bert 0.002 -lr_dec 0.2 -save_checkpoint_steps 20 -batch_size 140 -train_steps 200000 -report_every 1 -accum_count 5 \
# -use_bert_emb true -use_interval true -warmup_steps_bert 20000 -warmup_steps_dec 10000 -max_pos 512 -visible_gpus -1  -log_file ../logs/abs_bert_xsum \
# -neptune_api_token
